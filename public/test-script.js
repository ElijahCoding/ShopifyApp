...
fetch(`https://cors-anywhere.herokuapp.com/https://4b913a5ed961.ngrok.io/api/products?shop=${shop}`, {
    method: "GET",
    headers: {
...
$.ajax({
    url: `https://cors-anywhere.herokuapp.com/https://4b913a5ed961.ngrok.io/api/products?shop=${shop}`,
    type: 'Get',
